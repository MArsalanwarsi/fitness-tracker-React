  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <div
            className='mb-4 flex size-9 items-center justify-center rounded-full bg-sky-600/10 sm:mx-0 dark:bg-sky-400/10'>
          ...
          <ol
            className='text-muted-foreground mt-4 flex list-decimal flex-col gap-2 pl-6 text-sm'>
